...
var addNewPost_INTERNAL_API = async function (req, res) {
	...
	try {
		...
		//map keywords
		var keywordsObj =  {};
		if(postKeywordsArr.length > 1 && typeof postKeywordsArr[0] === 'string' && typeof postKeywordsArr[1] === 'string') {
			keywordsObj.Primary = [postKeywordsArr[0], postKeywordsArr[1]];
			keywordsObj.Secondary = postKeywordsArr.slice(2, postKeywordsArr.length);
		} else {
