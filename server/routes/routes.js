...
var journalControllerV2 = require('../controllers/journalControllerV2.js');
...
module.exports = function(router){
	...
	*/
	...
	router.get('/fsg/view', (req, res) => {
		fsg.findAll(req, res);
	});
	router.post('/fsg/add', (req, res) => {
		fsg.add(req, res);
	});
	router.post('/fsg/edit', (req, res) => {
		fsg.edit(req, res);
	});
	router.post('/fsg/delete', (req, res) => {
	...
	router.post('/massmediaupload/add', (req, res) => {
		media.uploadfile(req, res);
	});
	router.post('/media/uploadLink', (req, res) => {
		media.uploadLink(req, res);
	});
	
	router.post('/massmediaupload/edit', (req, res) => {
		media.edit(req, res);
	});
	router.post('/massmediaupload/editall', (req, res) => {
		media.editAll(req, res);
	});
	router.post('/massmediaupload/editTag', (req, res) => {
		media.editTags(req, res);
	});	
	router.post('/massmediaupload/view', (req, res) => {
		media.findAll(req, res);
	});
	router.post('/massmediaupload/view/all', (req, res) => {
	...
	router.post('/media/getUserPosts',function(req,res){
		media.getUserPosts(req,res)
	})

	router.post('/media/updatePostPrivacy',function(req,res){
	...
	// Journal routes
	router.post('/journal/addNewPost_INTERNAL_API', function(req, res) {
		journalControllerV2.addNewPost_INTERNAL_API(req, res);
	});
	
	router.post('/journal/addBlendImages_INTERNAL_API', function(req, res) {
		journalControllerV2.addBlendImages_INTERNAL_API(req, res);
	});
	
	router.post('/journal/generatePostBlendImage_INTERNAL_API', function(req, res) {
	...
	// Media routes for Midjourney sync
	router.get('/media/syncGdMjImage_INTERNAL_API', function(req, res) {
		// This function expects parameters as query params, not body
		media.syncGdMjImage_INTERNAL_API(req, res);
	});
	
	router.post('/media/syncGdTwoMjImage_INTERNAL_API', function(req, res) {
		// This function expects parameters in body
