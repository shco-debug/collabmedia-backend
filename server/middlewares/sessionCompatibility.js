...
module.exports = function(req, res, next) {
    ...
    if (req.user) {
        req.session.user = {
            ...
            SubscriptionPrice: req.user.subscriptionPrice || req.user.SubscriptionPrice || null,
            SubscriptionCurrency: req.user.subscriptionCurrency || req.user.SubscriptionCurrency || 'USD',
